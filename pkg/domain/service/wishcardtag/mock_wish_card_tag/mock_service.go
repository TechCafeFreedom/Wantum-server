...
// Source: pkg/domain/service/wishcardtag/service.go
...
// CreateMultipleRelation mocks base method
func (m *MockService) CreateMultipleRelation(ctx context.Context, masterTx repository.MasterTx, wishCardID int, tagIDs []int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateMultipleRelation", ctx, masterTx, wishCardID, tagIDs)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateMultipleRelation indicates an expected call of CreateMultipleRelation
func (mr *MockServiceMockRecorder) CreateMultipleRelation(ctx, masterTx, wishCardID, tagIDs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateMultipleRelation", reflect.TypeOf((*MockService)(nil).CreateMultipleRelation), ctx, masterTx, wishCardID, tagIDs)
}
