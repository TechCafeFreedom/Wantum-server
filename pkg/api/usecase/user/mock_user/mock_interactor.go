...
func (m *MockInteractor) CreateNewUser(ctx context.Context, authID, userName, mail, name, bio, phone, place string, thumbnail []byte, birth, gender int) (*entity.User, error) {
	m.ctrl.T.Helper()
